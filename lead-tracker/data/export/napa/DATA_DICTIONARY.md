...
**11,343 businesses** across **963 niches** and **89 cities** in Sonoma County, CA.
...
| `website` | 83% | Primary website URL (empty for ~17% = Tier A 'no site' leads). |
| `websites_all` | 83% | All listed website URLs, pipe-separated. |
...
**tier** (website need):
- A (no real website — hottest): 2,031
- B (DIY builder site — upsell): 110
- C (has a real website): 9,202

**industry_fit** (likelihood the niche buys web design):
- high: 5,617  ·  medium: 5,132  ·  low: 594
...
|---|---|
| winery | 1,189 |
| real_estate_agent | 443 |
| restaurant | 140 |
| beauty_salon | 127 |
| hair_salon | 122 |
| church_cathedral | 115 |
| community_services_non_profits | 103 |
| farm | 98 |
| automotive_repair | 94 |
| professional_services | 89 |
| wine_bar | 89 |
| mexican_restaurant | 88 |
| dentist | 83 |
| contractor | 81 |
| doctor | 80 |
| gym | 77 |
| liquor_store | 73 |
| american_restaurant | 70 |
| hotel | 69 |
| real_estate | 67 |
| spas | 63 |
| financial_service | 61 |
| insurance_agency | 61 |
| art_gallery | 60 |
| nail_salon | 60 |
